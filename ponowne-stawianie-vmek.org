...
Usage of php 7.3 from SCL repo changes things a little bit. Will have
...
* Extras
** Forgot how to connect to a remote server with emacs
...
** Change update_ssh_config.sh to use cached servers list
...
*** Debugging. So far doesn't really work.
...
**** Added a test for how many start and end block lines are there.
